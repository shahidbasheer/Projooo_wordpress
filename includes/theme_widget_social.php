        ...
        ?>
                <p>
                 ...
                 <p>
                    ...
                    <input class="widefat m-t-b" type="text" id="<?php echo $this->get_field_id('linkdin_username'); ?>" name="<?php echo $this->get_field_name('linkdin_username'); ?>" value="<?php echo esc_attr( $linkdin_username );?>" placeholder="Linkdin Username">                 
                </p>
